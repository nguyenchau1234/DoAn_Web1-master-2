...
function setListProducts(newList) {
    ...
    try {
        ...
        const jsonContent = JSON.stringify(newList);
        const blob = new Blob([jsonContent], {type: "application/json"});
        FileSaver.saveAs(blob, 'data-new.json');
    } catch(err) {
        console.log(err);
    }
}
...
function getListProducts() {
    return JSON.parse(window.localStorage.getItem('ListProducts')) || fetch('http://localhost:3000/list_products');
}
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Cửa hàng điện thoại uy tín nhất 2024</a> - Địa chỉ: 377 Tôn Đức Thắng, phường Hòa Khánh Nam, quận Liên Chiểu, thành phố Đà Nẵng - Hotline: 0864842599, Email: Cuahang2024@gmail.com - Thiết kế by
